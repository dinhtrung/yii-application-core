...
?>
	...
	<?php echo $form->textAreaControlGroup($model,'description',array('cols' => 70, 'size' => TbHtml::INPUT_SIZE_XXLARGE, 'rows' => 5, 'help'=> Yii::t('core', 'You may use <a target="_blank" href="http://daringfireball.net/projects/markdown/syntax">Markdown syntax</a>.'))); ?>
	...
	<?php echo $form->textFieldControlGroup($model,'viewfile',array(
			'help' => Yii::t('core', "The view file this block type will use. Provided as Yii path alias format.<br/>Finds a view file based on its name. The view name can be in one of the following formats:<br>
	<ul>
